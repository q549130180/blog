...
```
M2_HOME=D:\Developers\apache-maven-3.3.3
path=%M2_HOME%\bin;
```
...
export M2_HOME=/soft/apache-maven-3.0.5
...
1、在使用package、install等阶段跳过运行Test的配置
```xml
<build>   
  <plugins>   
    <plugin>   
...
参考资料
maven中央库：http://www.mvnrepository.com/
Maven核心概念和日常实践：https://segmentfault.com/a/1190000004448270
