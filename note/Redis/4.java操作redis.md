...
```xml
	...
	<bean id="connectionFactory" class="org.springframework.data.redis.connection.jedis.JedisConnectionFactory">
		...
		<property name="hostName" value="10.10.5.224" />
...
[使用Spring Data Redis操作Redis（一）][http://aiilive.blog.51cto.com/1925756/1627455]
[04.spring-data-redis与Jedis整合使用][http://www.cnblogs.com/LiZhiW/p/4853486.html]
[spring-data-redis与Jedis集成][http://www.voidcn.com/blog/gzzdark/article/p-4675782.html]
</div>
