...
### set log levels ###  
log4j.rootLogger = INFO, console, file,logFile,logMail,logDB
...
log4j.appender.file.layout.ConversionPattern=%-d{yyyy-MM-dd HH\:mm\:ss}  [ %t\:%r ] - [ %p ] [%l] %n%m%n  
log4j.appender.logFile.Threshold=DEBUG
log4j.appender.logFile.ImmediateFlush=TRUE
log4j.appender.logFile.Append=TRUE
log4j.appender.logFile.File=d:/logs/system-log.log
